    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    FirstAccountId = table.Column<long>(type: "bigint", nullable: false),
                    SecondAccountId = table.Column<long>(type: "bigint", nullable: false),
                    IsFriend = table.Column<bool>(type: "boolean", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Friends", x => new { x.FirstAccountId, x.SecondAccountId });
                    table.ForeignKey(
                        name: "FK_Friends_Accounts_FirstAccountId",
                        column: x => x.FirstAccountId,
                        principalTable: "Accounts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Friends_Accounts_SecondAccountId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Friends_SecondAccountId",
                table: "Friends",
